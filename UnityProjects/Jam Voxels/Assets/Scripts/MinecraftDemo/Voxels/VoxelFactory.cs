...
//			if(_voxelShell.parentChunkS==null)
//			_voxelShell.voxel.LoadMesh(new QuadFace_NoBottom(_voxelShell.neighbours, offsets, _spacing,new Vector2(_voxelShell.vp.x, _voxelShell.vp.z)));
//			else _voxelShell.voxel.LoadMesh(new QuadFace_NoBottom(_voxelShell.neighbours, offsets, _spacing,new Vector2(_voxelShell.vp.x, _voxelShell.vp.z),_voxelShell.parentChunkS.systemParent ));
			break;		
		case 2:	
			_voxelShell.filled = true;	
			break;
		...
		if(_voxelShell.parentChunk!=null)
