...
public class ChunkNeighbours {
	...
	public void UpdateNeighbourMeshes()
	{
		xneg_vcs.needsUpdating = true;
		xpos_vcs.needsUpdating = true;
		ypos_vcs.needsUpdating = true;
		yneg_vcs.needsUpdating = true;
		zpos_vcs.needsUpdating = true;
		zneg_vcs.needsUpdating = true;
	}
